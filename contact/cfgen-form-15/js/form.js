jQuery(function(){
	...
	form.on('click', 'img.cfgen-captcha-refresh', function(){
		...
		form.find('img.cfgen-captcha-img').prop('src','cfgen-form-15/inc/captcha.php?r='+Math.random());
	...
	form.on('click', 'input[type="submit"].cfgen-submit', function(){
		...
		jQuery.post('cfgen-form-15/inc/form-validation.php',
					post,
					function(data){
